...
public class PersonServiceImpl {
    ...
    public LoginResponseDto login(PersonDto personDto) throws Exception {
        ...
        try{
            entity = personRepository.findByUserNameAndPassword(personDto.getUsername(), convertPasswordToMD5(personDto.getPassword()));
        }catch (Exception e) {
    ...
    private String generateToken(){
        ...
        byte[] tokenBytes = new byte[32]; // Adjust the length as needed
